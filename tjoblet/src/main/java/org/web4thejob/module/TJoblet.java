 ...
 */
@Component
public class TJoblet extends AbstractJoblet {
    @Override
    ...
    public List<Resource> getResources() {
        ...
        try {
            for (Resource resource : resolver.getResources("classpath*:org/web4thejob/tjoblet/**/*.hbm.xml")) {
